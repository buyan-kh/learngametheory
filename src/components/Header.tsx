...
import { MicroscopeIcon, SimulateIcon, ScalesIcon, GamepadIcon, FolderIcon, GlobeIcon, VillageIcon } from '@/components/icons';
...
const modes: { key: AppMode; label: string; icon: ReactNode }[] = [
  ...
  { key: 'village', label: 'Village', icon: <VillageIcon /> },
];
